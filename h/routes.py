def includeme(config):  # pylint: disable=too-many-statements
    ...
    config.add_route("admin.terms", "/admin/terms")
    config.add_route("admin.terms_create", "/admin/terms/new")
    config.add_route(
        "admin.terms_delete",
        "/admin/terms/delete/{id}",
        factory="h.traversal.TermRoot",
        traverse="/{id}",
    )
    config.add_route(
        "admin.terms_edit",
    ...
    config.add_route("admin.courses_create", "/admin/courses/new")
    config.add_route(
        "admin.courses_delete",
        "/admin/courses/delete/{id}",
        factory="h.traversal.CourseRoot",
        traverse="/{id}",
    )
    config.add_route(
        "admin.courses_edit",
    ...
    config.add_route("admin.registrations_create", "/admin/registrations/new")
    config.add_route(
        "admin.registrations_delete",
        "/admin/registrations/delete/{id}",
        factory="h.traversal.RegistrationRoot",
        traverse="/{id}",
    )
    config.add_route(
        "admin.registrations_edit",
    ...
    config.add_route("admin.cost_items", "/admin/items")
    config.add_route("admin.cost_items_create", "/admin/items/new")
    config.add_route(
        "admin.cost_items_delete",
        "/admin/items/delete/{id}",
        factory="h.traversal.CostItemRoot",
        traverse="/{id}",
    )
    config.add_route(
        "admin.cost_items_edit",
        "/admin/items/{id}",
        factory="h.traversal.CostItemRoot",
        traverse="/{id}",
    )
